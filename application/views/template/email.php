                ...
                <tr style="background:#f1f1f2;">
                    <td>
                        <table width="500" border="0" cellspacing="0" cellpadding="0" style="padding: 0px 10px; font-size: 15px;">
                            <tbody>
                                <tr >
                                    <td>Su <?= $parentesco ?>: <span style="color:#0965a5; font-weight: bold;"><?= $nombreEstudiante ?></span> <b><?= $textoAbordo ?></b> abordó la ruta: <span style="color:#0965a5; font-weight: bold;"><?= $nombreRuta ?></span>  el día: <span style="color:#0965a5; font-weight: bold;"><?= $fecha ?></span>, en <?= $textoDestino ?>.</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
